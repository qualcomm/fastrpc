...
static const Method methods[1] = { { REMOTE_SCALARS_MAKEX(0, 0, 0x2, 0x0, 0x0, 0x0), 0x4, 0x0, 2, 1,
...
static __inline int _skel_method(int (*_pfn)(const unsigned char *, int), uint32_t _sc,
                                 remote_arg *_pra)
{
...
__QAIC_SKEL_EXPORT int __QAIC_SKEL(adspmsgd_apps_skel_invoke)(uint32_t _sc, remote_arg *_pra)
