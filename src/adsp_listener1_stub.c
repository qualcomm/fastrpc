...
static const Type types[3] = { { SLIM_IFPTR32(0x8, 0x10),
...
static const Parameter *const parameterArrays[26]
	...
	(&(parameters[10])), (&(parameters[3])), (&(parameters[4])), (&(parameters[11])),
	(&(parameters[6])),  (&(parameters[7])), (&(parameters[8])), (&(parameters[12])),
	(&(parameters[13])), (&(parameters[3])), (&(parameters[4])), (&(parameters[12])),
	(&(parameters[13])), (&(parameters[3])), (&(parameters[9])), (&(parameters[0])),
	(&(parameters[1])),  (&(parameters[2])) };
static const Method methods[7]
    = { { REMOTE_SCALARS_MAKEX(0, 0, 0x2, 0x0, 0x0, 0x1), 0x4, 0x0, 2, 2, (&(parameterArrays[23])),
	  0x4, 0x1 },
	{ REMOTE_SCALARS_MAKEX(0, 0, 0x0, 0x0, 0x1, 0x0), 0x0, 0x0, 1, 1, (&(parameterArrays[25])),
	  0x1, 0x0 },
	{ REMOTE_SCALARS_MAKEX(0, 0, 255, 255, 15, 15), 0x18, 0xc, 16, 9, (&(parameterArrays[0])),
	  0x4, 0x4 },
	{ REMOTE_SCALARS_MAKEX(0, 0, 255, 255, 15, 15), 0x8, 0x0, 4, 2, (&(parameterArrays[21])),
	  0x4, 0x1 },
	...
	{ REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x2, 0x0, 0x0), 0xc, 0x4, 6, 4, (&(parameterArrays[17])),
	  0x4, 0x4 } };
...
static const char strings[183]
    = "invoke_get_in_bufs\0routBufLenReq\0get_in_bufs2\0inBufLenReq\0next_"
      "invoke\0bufsLenReq\0prevResult\0inBuffers\0prevbufs\0outBufs\0prevCtx\0offset\0handle\0next2"
      "\0init2\0close\0init\0open\0ctx\0uri\0sc\0h\0";
static const uint16_t methodStrings[34]
    = { 58, 119, 81, 111, 169, 134, 177, 92, 46,  19, 141, 119, 81,  102, 169, 134, 177,
	14, 70,  33, 169, 127, 14,  70,  0,  169, 92, 164, 173, 180, 153, 180, 147, 159 };
...
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(adsp_listener1_slim)
    = { 8, &(methodArrays[0]), 0, 0, &(methodStringsArrays[0]), methodStrings, strings };
#endif //_ADSP_LISTENER1_SLIM_H

#ifdef __cplusplus
extern "C" {
#endif
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_listener1_open)(const char *uri,
...
static __inline int _stub_unpack_1(_ATTRIBUTE_UNUSED remote_arg *_praROutPost,
                                   _ATTRIBUTE_UNUSED remote_arg *_ppraROutPost[1],
                                   _ATTRIBUTE_UNUSED void *_primROut,
...
static __inline int _stub_pack(
...
static __inline int _stub_pack_1(
    _ATTRIBUTE_UNUSED _allocator *_al, _ATTRIBUTE_UNUSED remote_arg *_praIn,
    _ATTRIBUTE_UNUSED remote_arg *_ppraIn[1], _ATTRIBUTE_UNUSED remote_arg *_praROut,
    _ATTRIBUTE_UNUSED remote_arg *_ppraROut[1], _ATTRIBUTE_UNUSED remote_arg *_praHIn,
    _ATTRIBUTE_UNUSED remote_arg *_ppraHIn[1], _ATTRIBUTE_UNUSED remote_arg *_praHROut,
    _ATTRIBUTE_UNUSED remote_arg *_ppraHROut[1], _ATTRIBUTE_UNUSED void *_primIn,
    _ATTRIBUTE_UNUSED void *_primROut, _ATTRIBUTE_UNUSED char *_in0[1],
    _ATTRIBUTE_UNUSED uint32_t _in0Len[1])
{
	int _nErr = 0;
	remote_arg *_praInStart = _praIn;
                                 ...
                                 uint32_t _rout7Len[1], char *_rout8[1], uint32_t _rout8Len[1])
{
	...
	_ALLOCATE(_nErr, _al,
	          ((((((((_numIn[0] + _numROut[0]) + _numInH[0]) + _numROutH[0]) + 1) + 1) + 0) + 0)
	           * sizeof(_pra[0])),
	          4, _pra);
	_ASSERT(_nErr, _pra);
	...
	for (_ii = 0, _seq_primIn2 = (char *)_praIn[0].buf.pv, _seq_nat2 = (char *)_in2[0];
	     _ii < (int)_in2Len[0]; ++_ii, _seq_primIn2 = (_seq_primIn2 + 4),
	    _seq_nat2 = (_seq_nat2 + SLIM_IFPTR32(8, 16))) {
		_TRY(_nErr, _stub_pack_1(_al, (_praIn + 1), _ppraIn, (_praROut + 0), _ppraROut,
	...
	for (_ii = 0, _seq_primIn6 = (char *)_praIn[1].buf.pv, _seq_nat6 = (char *)_rout6[0];
	     _ii < (int)_rout6Len[0]; ++_ii, _seq_primIn6 = (_seq_primIn6 + 4),
	    _seq_nat6 = (_seq_nat6 + SLIM_IFPTR32(8, 16))) {
		_TRY(_nErr, _stub_pack(_al, (_praIn + 2), _ppraIn, (_praROut + 0), _ppraROut,
	...
	for (_ii = 0, _seq_nat2 = (char *)_in2[0]; _ii < (int)_in2Len[0];
	     ++_ii, _seq_nat2 = (_seq_nat2 + SLIM_IFPTR32(8, 16))) {
		_TRY(_nErr,
		     _stub_unpack_1((_praROutPost + 0), _ppraROutPost, 0,
		                    SLIM_IFPTR32((char **)&(((uint32_t *)_seq_nat2)[0]),
		                                 (char **)&(((uint64_t *)_seq_nat2)[0])),
		                    SLIM_IFPTR32((uint32_t *)&(((uint32_t *)_seq_nat2)[1]),
		                                 (uint32_t *)&(((uint32_t *)_seq_nat2)[2]))));
	...
	for (_ii = 0, _seq_nat6 = (char *)_rout6[0]; _ii < (int)_rout6Len[0];
	     ++_ii, _seq_nat6 = (_seq_nat6 + SLIM_IFPTR32(8, 16))) {
		_TRY(_nErr, _stub_unpack((_praROutPost + 0), _ppraROutPost, 0,
		                         SLIM_IFPTR32((char **)&(((uint32_t *)_seq_nat6)[0]),
		                                      (char **)&(((uint64_t *)_seq_nat6)[0])),
		                         SLIM_IFPTR32((uint32_t *)&(((uint32_t *)_seq_nat6)[1]),
		                                      (uint32_t *)&(((uint32_t *)_seq_nat6)[2]))));
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_listener1_next_invoke)(
    ...
    const adsp_listener1_buffer *outBufs, int outBufsLen, adsp_listener1_invoke_ctx *ctx,
    adsp_listener1_remote_handle *handle, uint32_t *sc, adsp_listener1_buffer *inBuffers,
    int inBuffersLen, int *inBufLenReq, int inBufLenReqLen, int *routBufLenReq,
    int routBufLenReqLen) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 2;
	return _stub_method(
	    _handle, _mid, (uint32_t *)&prevCtx, (uint32_t *)&prevResult, (void **)&outBufs,
	    (uint32_t *)&outBufsLen, (uint32_t *)ctx, (uint32_t *)handle, (uint32_t *)sc,
	    (void **)&inBuffers, (uint32_t *)&inBuffersLen, (char **)&inBufLenReq,
	    (uint32_t *)&inBufLenReqLen, (char **)&routBufLenReq, (uint32_t *)&routBufLenReqLen);
}
static __inline int _stub_unpack_2(_ATTRIBUTE_UNUSED remote_arg *_praROutPost,
                                   _ATTRIBUTE_UNUSED remote_arg *_ppraROutPost[1],
                                   _ATTRIBUTE_UNUSED void *_primROut,
                                   _ATTRIBUTE_UNUSED char *_rout0[1],
                                   _ATTRIBUTE_UNUSED uint32_t _rout0Len[1])
...
static __inline int _stub_pack_2(
    _ATTRIBUTE_UNUSED _allocator *_al, _ATTRIBUTE_UNUSED remote_arg *_praIn,
    _ATTRIBUTE_UNUSED remote_arg *_ppraIn[1], _ATTRIBUTE_UNUSED remote_arg *_praROut,
    _ATTRIBUTE_UNUSED remote_arg *_ppraROut[1], _ATTRIBUTE_UNUSED remote_arg *_praHIn,
    _ATTRIBUTE_UNUSED remote_arg *_ppraHIn[1], _ATTRIBUTE_UNUSED remote_arg *_praHROut,
...
static __inline int _stub_method_1(remote_handle64 _handle, uint32_t _mid, uint32_t _in0[1],
                                   void *_rout1[1], uint32_t _rout1Len[1])
{
	...
	_allocator_init(_al, 0, 0);
	_ALLOCATE(_nErr, _al,
	          ((((((((_numIn[0] + _numROut[0]) + _numInH[0]) + _numROutH[0]) + 1) + 0) + 0) + 0)
	           * sizeof(_pra[0])),
	          4, _pra);
	_ASSERT(_nErr, _pra);
	_pra[0].buf.pv = (void *)_primIn;
	...
	for (_ii = 0, _seq_primIn1 = (char *)_praIn[0].buf.pv, _seq_nat1 = (char *)_rout1[0];
	     _ii < (int)_rout1Len[0]; ++_ii, _seq_primIn1 = (_seq_primIn1 + 4),
	    _seq_nat1 = (_seq_nat1 + SLIM_IFPTR32(8, 16))) {
		_TRY(_nErr, _stub_pack_2(_al, (_praIn + 1), _ppraIn, (_praROut + 0), _ppraROut,
	...
	for (_ii = 0, _seq_nat1 = (char *)_rout1[0]; _ii < (int)_rout1Len[0];
	     ++_ii, _seq_nat1 = (_seq_nat1 + SLIM_IFPTR32(8, 16))) {
		_TRY(_nErr,
		     _stub_unpack_2((_praROutPost + 0), _ppraROutPost, 0,
		                    SLIM_IFPTR32((char **)&(((uint32_t *)_seq_nat1)[0]),
		                                 (char **)&(((uint64_t *)_seq_nat1)[0])),
		                    SLIM_IFPTR32((uint32_t *)&(((uint32_t *)_seq_nat1)[1]),
		                                 (uint32_t *)&(((uint32_t *)_seq_nat1)[2]))));
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_listener1_invoke_get_in_bufs)(
    remote_handle64 _handle, adsp_listener1_invoke_ctx ctx, adsp_listener1_buffer *inBuffers,
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_listener1_init2)(remote_handle64 _handle)
    __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 5;
	return _stub_method_2(_handle, _mid);
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_listener1_next2)(
    ...
    adsp_listener1_remote_handle *handle, uint32_t *sc, uint8_t *bufs, int bufsLen,
    int *bufsLenReq) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 6;
	return _stub_method_3(_handle, _mid, (uint32_t *)&prevCtx, (uint32_t *)&prevResult,
	                      (char **)&prevbufs, (uint32_t *)&prevbufsLen, (uint32_t *)ctx,
	                      (uint32_t *)handle, (uint32_t *)sc, (char **)&bufs,
	                      (uint32_t *)&bufsLen, (uint32_t *)bufsLenReq);
}
static __inline int _stub_method_4(remote_handle64 _handle, uint32_t _mid, uint32_t _in0[1],
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_listener1_get_in_bufs2)(
    remote_handle64 _handle, adsp_listener1_invoke_ctx ctx, int offset, uint8_t *bufs, int bufsLen,
    int *bufsLenReq) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 7;
	return _stub_method_4(_handle, _mid, (uint32_t *)&ctx, (uint32_t *)&offset, (char **)&bufs,
	                      (uint32_t *)&bufsLen, (uint32_t *)bufsLenReq);
}
#ifdef __cplusplus
}
