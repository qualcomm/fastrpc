...
static const Parameter *const parameterArrays[23]
    = { (&(parameters[0])), (&(parameters[1])), (&(parameters[1])), (&(parameters[4])),
	(&(parameters[5])), (&(parameters[6])), (&(parameters[6])), (&(parameters[0])),
	(&(parameters[1])), (&(parameters[1])), (&(parameters[1])), (&(parameters[2])),
	(&(parameters[3])), (&(parameters[3])), (&(parameters[0])), (&(parameters[0])),
	(&(parameters[6])), (&(parameters[6])), (&(parameters[0])), (&(parameters[0])),
	(&(parameters[0])), (&(parameters[4])), (&(parameters[0])) };
static const Method methods[8] = { { REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x1, 0x0, 0x0), 0x14, 0x8, 7,
	                             7, (&(parameterArrays[7])), 0x4, 0x4 },
	                           { REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x0, 0x0, 0x0), 0x8, 0x0, 2, 2,
	                             (&(parameterArrays[10])), 0x4, 0x0 },
	                           { REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x1, 0x0, 0x0), 0x20, 0x10, 11,
	                             7, (&(parameterArrays[0])), 0x8, 0x8 },
	                           { REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x0, 0x0, 0x0), 0x10, 0x0, 6,
	                             2, (&(parameterArrays[3])), 0x8, 0x0 },
	                           { REMOTE_SCALARS_MAKEX(0, 0, 0x1, 0x1, 0x0, 0x0), 0x8, 0x10, 4,
	                             4, (&(parameterArrays[14])), 0x4, 0x8 },
...
static const char strings[170]
    = "dma_handle_unmap\0request_unmap64\0dma_handle_map\0request_map64\0request_unmap\0share_"
      "unmap\0request_map\0share_map\0ion_"
...
static __inline int _skel_method_3(int (*_pfn)(int, int, uint64_t *, uint64_t *), uint32_t _sc,
                                   remote_arg *_pra)
{
	remote_arg *_praEnd = 0;
	uint32_t _in0[1] = { 0 };
...
static __inline int _skel_method_5(int (*_pfn)(int, uint32_t, uint32_t, uint64_t, int64_t,
                                               uint64_t *, uint64_t *),
                                   uint32_t _sc, remote_arg *_pra)
{
	...
	_TRY(_nErr, _pfn((int)*_in0, (uint32_t)*_in1, (uint32_t)*_in2, (uint64_t)*_in3,
	                 (int64_t)*_in4, (uint64_t *)_rout5, (uint64_t *)_rout6));
...
static __inline int _skel_method_7(int (*_pfn)(int, uint32_t, uint32_t, uint32_t, int32_t,
                                               uint32_t *, uint32_t *),
                                   uint32_t _sc, remote_arg *_pra)
{
	remote_arg *_praEnd = 0;
	...
	_TRY(_nErr, _pfn((int)*_in0, (uint32_t)*_in1, (uint32_t)*_in2, (uint32_t)*_in3,
	                 (int32_t)*_in4, (uint32_t *)_rout5, (uint32_t *)_rout6));
	_COPY(_primROut, 0, _rout5, 0, 4);
	_COPY(_primROut, 4, _rout6, 0, 4);
	_CATCH(_nErr) {}
	return _nErr;
}
__QAIC_SKEL_EXPORT int __QAIC_SKEL(apps_mem_skel_invoke)(uint32_t _sc,
