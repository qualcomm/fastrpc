...
static const Parameter *const parameterArrays[7]
    = { (&(parameters[3])), (&(parameters[3])), (&(parameters[3])), (&(parameters[1])),
...
static const Method methods[6]
	...
	{ REMOTE_SCALARS_MAKEX(0, 0, 255, 255, 15, 15), 0x8, 0x0, 3, 2, (&(parameterArrays[4])),
	  0x4, 0x0 },
	{ REMOTE_SCALARS_MAKEX(0, 0, 0x0, 0x1, 0x0, 0x0), 0x0, 0x4, 1, 1, (&(parameterArrays[6])),
	  0x1, 0x4 },
...
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(adsp_current_process_slim)
    = { 9, &(methodArrays[0]), 0, 0, &(methodStringsArrays[0]), methodStrings, strings };
...
__QAIC_STUB_EXPORT remote_handle _adsp_current_process_handle(void)
{
	...
	if (adsp_pls_add_lookup) {
		if (0
		    == adsp_pls_add_lookup((uint32_t)_adsp_current_process_handle, 0, sizeof(*ph),
		...
		if (0
		    == HAP_pls_add_lookup((uint32_t)_adsp_current_process_handle, 0, sizeof(*ph),
		                          _adsp_current_process_pls_ctor, "adsp_current_process",
		                          _adsp_current_process_pls_dtor, (void **)&ph)) {
			return *ph;
		}
...
uint32_t _adsp_current_process_atomic_CompareAndExchange(uint32_t *volatile puDest,
...
static __inline int _stub_method_1(remote_handle _handle, uint32_t _mid, uint16_t _in0[1],
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process_set_logging_params)(
    unsigned short mask, const _cstring1_t *filesToLog, int filesToLogLen) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 2;
	remote_handle _handle = _adsp_current_process_handle();
	if (_handle != (remote_handle)-1) {
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process_getASID)(unsigned int *asid)
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process_setQoS)(unsigned int latency)
    __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 4;
	remote_handle _handle = _adsp_current_process_handle();
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process_set_logging_params2)(
    unsigned int mask, const _cstring1_t *filesToLog, int filesToLogLen) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 6;
	remote_handle _handle = _adsp_current_process_handle();
	if (_handle != (remote_handle)-1) {
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_current_process_enable_notifications)(void)
    __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 8;
	remote_handle _handle = _adsp_current_process_handle();
