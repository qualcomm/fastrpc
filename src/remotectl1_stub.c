...
static const Parameter *const parameterArrays[14]
    = { (&(parameters[0])), (&(parameters[3])), (&(parameters[4])), (&(parameters[3])),
	(&(parameters[5])), (&(parameters[4])), (&(parameters[3])), (&(parameters[5])),
	(&(parameters[7])), (&(parameters[6])), (&(parameters[6])), (&(parameters[0])),
	(&(parameters[1])), (&(parameters[2])) };
static const Method methods[6] = { { REMOTE_SCALARS_MAKEX(0, 0, 0x2, 0x0, 0x0, 0x1), 0x4, 0x0, 2, 2,
...
static const char strings[103] = "set_param\0grow_"
				 "heap\0phyAddr\0dlerror\0params\0close1\0handle\0reqID\0nSize\0ope"
				 "n1\0close\0nErr\0name\0open\0uri\0h\0";
static const uint16_t methodStrings[20]
    = { 69, 86, 50, 28, 81, 43, 50, 28, 81, 0, 57, 36, 10, 20, 63, 91, 96, 100, 75, 100 };
...
extern "C" {
#endif
__QAIC_STUB_EXPORT int __QAIC_STUB(remotectl1_open)(const char *uri,
...
static __inline int _stub_method(remote_handle64 _handle, uint32_t _mid, char *_in0[1],
...
__QAIC_STUB_EXPORT int __QAIC_STUB(remotectl1_open1)(remote_handle64 _handle, const char *name,
                                                     int *handle, char *dlerror, int dlerrorLen,
                                                     int *nErr) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 2;
	return _stub_method(_handle, _mid, (char **)&name, (uint32_t *)handle, (char **)&dlerror,
...
__QAIC_STUB_EXPORT int __QAIC_STUB(remotectl1_close1)(remote_handle64 _handle, int handle,
...
__QAIC_STUB_EXPORT int __QAIC_STUB(remotectl1_grow_heap)(remote_handle64 _handle, uint32_t phyAddr,
...
__QAIC_STUB_EXPORT int __QAIC_STUB(remotectl1_set_param)(remote_handle64 _handle, int reqID,
