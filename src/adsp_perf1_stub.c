...
static const Parameter *const parameterArrays[8]
	...
	(&(parameters[1])), (&(parameters[4])), (&(parameters[3])), (&(parameters[2])) };
static const Method methods[5] = { { REMOTE_SCALARS_MAKEX(0, 0, 0x2, 0x0, 0x0, 0x1), 0x4, 0x0, 2, 2,
...
static const char strings[66]
    = "get_usecs\0get_keys\0numKeys\0maxLen\0enable\0close\0open\0dst\0uri\0ix\0h\0";
...
extern "C" {
#endif
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_perf1_open)(const char *uri,
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_perf1_enable)(remote_handle64 _handle,
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_perf1_get_usecs)(remote_handle64 _handle, int64_t *dst,
                                                         int dstLen) __QAIC_STUB_ATTRIBUTE
{
	uint32_t _mid = 3;
	return _stub_method_1(_handle, _mid, (char **)&dst, (uint32_t *)&dstLen);
}
static __inline int _stub_method_2(remote_handle64 _handle, uint32_t _mid, char *_rout0[1],
...
__QAIC_STUB_EXPORT int __QAIC_STUB(adsp_perf1_get_keys)(remote_handle64 _handle, char *keys,
