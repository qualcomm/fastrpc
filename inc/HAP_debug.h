...
static __inline void _HAP_debug_v2(int level, const char *file, int line, const char *format, ...)
{
	char buf[256];
	va_list args;
...
*/
bool HAP_log_data_packet(unsigned short log_code_type, unsigned int dataLen, unsigned char *data);
