...
#define AEE_ENOMEMORY                                                                              \
	(AEE_EOFFSET + 0x002) ///< Memory allocation failed because of insufficient RAM
...
#define AEE_EINCOMPLETEITEM                                                                        \
	(AEE_EOFFSET + 0x012) ///< Incomplete item, like length of a string is less that expected
...
#define AEE_EINVALIDITEM                                                                           \
	(AEE_EOFFSET                                                                               \
	 + 0x02A) ///< Current item is invalid, it can be a switch case or a pointer to memory
#define AEE_ENOTALLOWED                                                                            \
	(AEE_EOFFSET + 0x02B) ///< Not allowed to perform the
	                      ///< operation
#define AEE_EINVHANDLE                                                                             \
	(AEE_EOFFSET + 0x02C) ///< Invalid handle - adding here as its defined in vendor AEEStdErr.h
...
#define AEE_EREADONLY                                                                              \
	(AEE_EOFFSET + 0x031)           ///< Cannot change read-only
...
#define AEE_EINVALIDDEVICE                                                                         \
	(AEE_EOFFSET + 0x03B) ///<  Invalid Device or Device node open failed for the domain
...
#define AEE_EFOPEN                                                                                 \
	(AEE_EOFFSET + 0x057) ///<  file open error or device node open failed for DSP domain
...
#define AEE_EMAX_MMPM_CLIENTS                                                                      \
	(AEE_EOFFSET + 0x176) ///<  MMPM Reached maximum clients per PD(HAP_MAX_CLIENTS)
