 ...
 * @retval, 0 on success
 */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_perf1_open)(const char *uri,
...
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_perf1_enable)(remote_handle64 _h,
                                                          int ix) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_perf1_get_usecs)(remote_handle64 _h, int64_t *dst,
                                                             int dstLen) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_perf1_get_keys)(remote_handle64 _h, char *keys,
