...
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_current_process_set_logging_params)(
    unsigned short mask, const _cstring1_t *filesToLog, int filesToLogLen) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_current_process_getASID)(unsigned int *asid)
    __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_current_process_setQoS)(unsigned int latency)
    __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_current_process_exception)(void)
    __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_current_process_set_logging_params2)(
    unsigned int mask, const _cstring1_t *filesToLog, int filesToLogLen) __QAIC_HEADER_ATTRIBUTE;
...
__QAIC_HEADER_EXPORT int __QAIC_HEADER(adsp_current_process_enable_notifications)(void)
    __QAIC_HEADER_ATTRIBUTE;
#ifdef __cplusplus
}
#endif
