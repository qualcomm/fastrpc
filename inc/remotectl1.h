 ...
 * @retval, 0 on success
 */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(remotectl1_open)(const char *uri,
...
__QAIC_HEADER_EXPORT int __QAIC_HEADER(remotectl1_open1)(remote_handle64 _h, const char *name,
                                                         int *handle, char *dlerror, int dlerrorLen,
                                                         int *nErr) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(remotectl1_close1)(remote_handle64 _h, int handle,
                                                          char *dlerror, int dlerrorLen,
                                                          int *nErr) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(remotectl1_grow_heap)(
    remote_handle64 _h, uint32_t phyAddr, uint32_t nSize) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(remotectl1_set_param)(remote_handle64 _h, int reqID,
